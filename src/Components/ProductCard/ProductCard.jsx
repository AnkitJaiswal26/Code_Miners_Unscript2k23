        ...
        <div class="mx-10 my-5">
            <div class="max-w-sm rounded overflow-hidden shadow-lg">
                ...
                <div className='flex justify-center mt-2'>
                    <button type="button" className="mb-6 inline-block px-16 py-3 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
